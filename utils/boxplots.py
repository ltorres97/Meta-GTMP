...
fig, ax = plt.subplots()
ax = sns.boxplot(x='Metric',y='value',data=dd,hue='Models', ax=ax, palette="YlGnBu", boxprops=dict(alpha=.2), linewidth=0.2, showfliers=False)
#plt.setp(ax.artists,fill=False) 
ylims=ax.get_ylim()
sns.stripplot(x="Metric", y="value", hue='Models', data=dd, dodge=True, palette="YlGnBu", ax=ax, ec='k', linewidth=0,  size=2.5, alpha = 1)
ax.set(ylim=ylims)
...
fig, ax = plt.subplots()
ax = sns.barplot(x='value',y='Experiment',data=dd,hue='Models', ax=ax, palette="YlGnBu", linewidth=0.85, errorbar="sd", capsize = 0.05, errwidth = 2)
#sns.stripplot(x="Metric", y="value", hue='Models', data=dd, dodge=True, palette="YlGnBu", ax=ax, ec='k', linewidth=0.5,  size=2, alpha = 0.7)
sns.set(style = 'whitegrid')
#ax.axhline(y =0.719, ls='--', c='darkred', linewidth = 0.5)
...
dd=pd.melt(df_final,id_vars=['Experiment'],value_vars=['ST-TA98','ST-TA100','ST-TA102','ST-TA1535','ST-TA1537','All-Tasks'],var_name='Models')
fig, ax = plt.subplots()
ax = sns.boxplot(x='Experiment',y='value',data=dd,hue='Models', ax=ax, palette="YlGnBu", boxprops=dict(alpha=.1), linewidth=0.5, showfliers=False)
plt.setp(ax.artists,fill=False) 
ylims=ax.get_ylim()
sns.stripplot(x="Experiment", y="value", hue='Models', data=dd, dodge=True, palette="YlGnBu", ax=ax, ec='k', linewidth=0,  size=3, alpha = 1)
ax.set(ylim=ylims)
#ax.axhline(y =0.719, ls='--', c='darkred', linewidth = 0.5)
ax.set(xlabel='', ylabel='Score')
sns.move_legend(ax, "upper left", bbox_to_anchor=(1, 1))
...
ax.legend(handles[:4], labels[:4], bbox_to_anchor=(1, 1.02), loc='upper left')
sns.move_legend(ax, "lower center", bbox_to_anchor=(.5, 1), ncol=4, title=None, frameon=False, fontsize=10)
plt.savefig('boxplot_ST_models.png', dpi=300, bbox_inches='tight')
